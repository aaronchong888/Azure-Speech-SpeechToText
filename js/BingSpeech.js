        ...
        checkAuthToken() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.authToken === "" || timeElapsed > 500) {
                    ...
                    try {
                        var resultsText = yield this.makeHttpRequest("POST", "https://eastasia.api.cognitive.microsoft.com/sts/v1.0/issuetoken", false, optionalHeaders);
        ...
        recognizeAudio(audio, locale) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    response = yield this._tools.makeHttpRequest("POST", "https://eastasia.stt.speech.microsoft.com/speech/recognition/conversation/cognitiveservices/v1" + requestParameters, false, optionalHeaders, blob);
